...
const Login = () => {
  ...
  return (
    <div {...swipeHandlers} className="min-h-screen flex flex-col">
      {/* Header */}
      ...
      <div className="flex border-b border-border">
        <Link to="/login" className="flex-1 py-4 text-center text-teal-500 border-b-2 border-teal-500 font-medium">
          Log in
        </Link>
      ...
      <div className="flex-1 p-6 animate-fade-in">
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="w-full bg-teal-500 text-white py-3 rounded-md font-medium hover:bg-opacity-90 transition-colors">
            Log in
          </button>
        </form>
