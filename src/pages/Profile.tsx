...
const Profile = () => {
  ...
  const toggleBalance = () => {
    ...
    toast({
      ...
      description: showBalance
        ? "Your balance is now hidden"
        : "Your balance is now visible",
      duration: 2000,
    });
  };
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetContent
        side="top"
        className="h-full w-full p-0 sm:max-w-full border-none"
      >
        <div className="flex flex-col bg-background h-full overflow-y-auto">
          ...
          <div className="p-4 bg-background">
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <Button
                variant="outline"
                className="bg-background text-white border-gray-700 hover:bg-gray-700"
              >
                Withdrawal
              </Button>
              <Button
          ...
          <div className="flex flex-col">
            ...
            <MenuItem
              ...
              onClick={() => navigateTo("/transaction-records")}
            />
            <MenuItem
              icon={PieChart}
              label="Betting records"
              onClick={() => navigateTo("/betting-records")}
            />
            <MenuItem
              icon={BarChart3}
              label="Turnover"
              onClick={() => navigateTo("/turnover")}
            />
            <MenuItem
              icon={Crown}
              label="My VIP"
              onClick={() => navigateTo("/my-vip")}
            />
            <MenuItem
              icon={Users}
              label="My referral"
              onClick={() => navigateTo("/my-referral")}
            />
          </div>
